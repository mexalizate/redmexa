...
export const routeConfig = {
  ...
  spendingRequestHistory: new RouteConfig({
    ...
    exact: true,
    neededAuthentication: AUTHENTICATION.HARD,
    label: _("Historique de la demande"),
    Component: RouteComponents.SpendingRequestHistory,
    backLink: {
      label: _("Détails de la demande"),
  ...
  editSpendingRequest: new RouteConfig({
    ...
    exact: true,
    neededAuthentication: AUTHENTICATION.HARD,
    label: _("Modification de la dépense"),
    Component: RouteComponents.EditSpendingRequest,
    hideFeedbackButton: true,
    backLink: {
      label: _("Détail de la demande"),
      route: "spendingRequestDetails",
    },
  }),
  ...
  contributionSuccess: new RouteConfig({
    ...
    exact: true,
    neededAuthentication: AUTHENTICATION.NONE,
    label: _("Devenir financeur·euse de la France insoumise"),
  ...
  newVotingProxyRequest: new RouteConfig({
    ...
    exact: true,
    neededAuthentication: AUTHENTICATION.NONE,
    label: _("Donner ma procuration de vote"),
  ...
  newVotingProxy: new RouteConfig({
    ...
    exact: true,
    neededAuthentication: AUTHENTICATION.NONE,
    label: _("Prendre une procuration de vote"),
  ...
  searchEvent: new RouteConfig({
    ...
    label: _("Rechercher un événement"),
    hasLayout: false,
    hideFeedbackButton: true,
  }),
  ...
  newPollingStationOfficer: new RouteConfig({
    ...
    exact: true,
    neededAuthentication: AUTHENTICATION.NONE,
    label: _("Devenir assesseur·e ou délégué·e"),
